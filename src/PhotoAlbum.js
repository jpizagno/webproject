...
class PhotoAlbum extends Component {
 constructor(props) {
  ...
  componentDidMount() {
    var that = this;
    var elementAll = document.getElementById("all");
    if (elementAll) {
    	elementAll.addEventListener('click', that.changeStateAlbum, false);
    }
    var elementTristan=document.getElementById("tristan");
    if (elementTristan) {
       elementTristan.addEventListener('click', that.changeStateAlbum, false);
    }
  }
